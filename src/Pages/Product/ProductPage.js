      ...
      <div className="pc2">
        {showreview ? (
          <div className="tabs">
            ...
            className="inactive">Description</button>
            <button onClick={()=>{setShowreview(true)}}  className="active">Reviews</button>
          </div>
        ) : (
          <div className="tabs">
            <button onClick={()=>{setShowreview(false)}} className="active">Description</button>
            <button onClick={()=>{setShowreview(true)}}  className="inactive">Reviews</button>
          </div>
        )}
        {showreview ? (
